...
class FSQ(nn.Module):
    """Minimal FSQ (https://arxiv.org/abs/2309.15505) implementation.
    ...
    # TODO(roman-bachmann): Not ideal that we have to indicate device_type to disable autocast
